...
public class PersonControllerTest {
    ...
    public void deletePersonTest() throws Exception {
        ...
        verify(personService, times(1)).deleteByFirstNameAndLastName(firstNameArgumentCaptor.capture(), lastNameArgumentCaptor.capture());

        Assert.assertEquals(firstName, firstNameArgumentCaptor.getValue());
        Assert.assertEquals(lastName, lastNameArgumentCaptor.getValue());
    }
